...
// green book version:
var book2_colour = "green";
if (book2_colour == "green") {
    console.log("You just read and learn!"); // Output : You just read and learn!
}
else if (book2_colour == "yellow") {
...
// red book version:
var book3_colour = "red";
if (book3_colour == "green") {
    console.log("You just read and learn!");
}
else if (book3_colour == "yellow") {
